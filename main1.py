...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='C:/Users/Akhil/Agriculture-Vision-Segmentation', required=False,
                        help='training directory (default: C:/Users/Akhil/Agriculture-Vision-Segmentation)')
    parser.add_argument('--dir', type=str, default='C:/Users/Akhil/Agriculture-Vision-Segmentation', required=False, help='training directory (default: tmp)')
    ...
    parser.add_argument('--clr_step', type=int, default=4, required=False, help='CLR step size (default: 4000)')
    ...
    if os.name == 'nt':
        root_folder = pathlib.Path('C:/Users/Akhil/Agriculture-Vision-Segmentation')
        sep_path = "\\"
        print(root_folder)
    else:
    ...
    train_full = sorted(glob.glob(os.path.join(root_folder, 'train/images/rgb/*.jpg')))
    ...
    STEPS_PER_EPOCH = 1*(STEPS_PER_EPOCH // 100)

    if args.lr_max > args.lr_init:
        clr_step_size = args.clr_step
        lr_schedule = tf.optimizers.cyclical_learning_rate.TriangularCyclicalLearningRate(
    ...
    optimizer = tf.keras.optimizers.SGD(learning_rate=0.01, momentum=args.momentum, decay=args.wd)
